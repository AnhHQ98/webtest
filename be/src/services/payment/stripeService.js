...
if (!DISABLE_STRIPE) {
  ...
  console.warn('⚠️ Stripe is temporarily disabled.');
}

if (DISABLE_STRIPE) {
  module.exports = new (class {
    async createPaymentIntent() { console.warn('Stripe disabled.'); }
    async confirmPaymentIntent() { console.warn('Stripe disabled.'); }
    async createCustomer() { console.warn('Stripe disabled.'); }
    async getCustomer() { console.warn('Stripe disabled.'); }
    async createRefund() { console.warn('Stripe disabled.'); }
    async handleWebhook() { console.warn('Stripe disabled.'); }
    async getPaymentMethods() { console.warn('Stripe disabled.'); }
    async createSetupIntent() { console.warn('Stripe disabled.'); }
  })();
  return;
}
